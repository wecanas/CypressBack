...
class Registry {
    ...
    finalize(newId) {
        ...
        for (const preliminaryHook of this.preliminaryHooks) {
            this.caseHooks.push(Object.assign({ id: newId() }, preliminaryHook));
        }
    }
    ...
    defineCaseHook(keyword, options, fn) {
        ...
        this.preliminaryHooks.push(Object.assign({ node: parseMaybeTags(options.tags), implementation: fn, keyword: keyword, position: (0, source_map_1.maybeRetrievePositionFromSourceMap)(), order: order !== null && order !== void 0 ? order : exports.DEFAULT_HOOK_ORDER }, remainingOptions));
    }
