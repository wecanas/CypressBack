...
async function compile(configuration, data, uri) {
    ...
    const implicitIntegrationFolder = (0, assertions_1.assertAndReturn)((0, common_ancestor_path_1.default)(...(0, find_cypress_specs_1.getSpecs)(configuration, "foobar", true)
