...
const messages_enums_1 = require("./helpers/messages-enums");
...
function createPickle(context, pickle) {
    ...
    const scenario = (0, assertions_1.assertAndReturn)(context.astIdsMap.get((0, assertions_1.assertAndReturn)((_b = pickle.astNodeIds) === null || _b === void 0 ? void 0 : _b[0], "Expected to find at least one astNodeId")), `Expected to find scenario associated with id = ${(_c = pickle.astNodeIds) === null || _c === void 0 ? void 0 : _c[0]}`);
                    ...
                    return beforeHooksChain.then(() => {
                        try {
                            return (0, cypress_1.runStepWithLogGroup)({
                                ...
                                argument,
                                text,
                                fn: () => registry.runStepDefinition(this, text, dryRun, argument),
                            }).then((result) => {
        ...
        if (((_a = this.currentTest) === null || _a === void 0 ? void 0 : _a.state) === "failed") {
            ...
            const failedTestStepFinished = error.includes("Step implementation missing")
                ? {
                    ...
                    testCaseStartedId,
                    testStepResult: {
                        status: messages_enums_1.TestStepResultStatus.UNDEFINED,
                        duration: {
                            seconds: 0,
                            nanos: 0,
                        },
                ...
                : {
                    ...
                    testStepResult: {
                        status: error.includes("Multiple matching step definitions for")
                            ? messages_enums_1.TestStepResultStatus.AMBIGUOUS
                            : messages_enums_1.TestStepResultStatus.FAILED,
                        message: error,
            ...
            for (const remainingStep of remainingSteps) {
                ...
                taskTestStepFinished(context, {
                    ...
                    testCaseStartedId,
                    testStepResult: {
                        status: messages_enums_1.TestStepResultStatus.UNKNOWN,
                        duration: {
                            seconds: 0,
                            nanos: 0,
                        },
...
function createTests(registry, seed, source, gherkinDocument, pickles, isTrackingState, omitFiltered, stepDefinitionHints, dryRun) {
    ...
    const stepDefinitions = registry.stepDefinitions.map((stepDefinition) => {
        const type = stepDefinition.expression instanceof cucumber_expressions_1.RegularExpression
            ? messages_enums_1.StepDefinitionPatternType.REGULAR_EXPRESSION
            : messages_enums_1.StepDefinitionPatternType.CUCUMBER_EXPRESSION;
        return {
    ...
    specEnvelopes.push({
        source: {
            ...
            mediaType: messages_enums_1.SourceMediaType.TEXT_X_CUCUMBER_GHERKIN_PLAIN,
        },
    });
    specEnvelopes.push({
        gherkinDocument,
