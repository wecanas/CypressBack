...
function attach(data, mediaType) {
    if (typeof data === "string") {
        ...
        if (mediaType.startsWith("base64:")) {
            createStringAttachment(data, mediaType.replace("base64:", ""), messages_enums_1.AttachmentContentEncoding.BASE64);
        }
        else {
            createStringAttachment(data, mediaType !== null && mediaType !== void 0 ? mediaType : "text/plain", messages_enums_1.AttachmentContentEncoding.IDENTITY);
        }
    }
        ...
        createStringAttachment((0, base64_js_1.fromByteArray)(new Uint8Array(data)), mediaType, messages_enums_1.AttachmentContentEncoding.BASE64);
    }
    else {
