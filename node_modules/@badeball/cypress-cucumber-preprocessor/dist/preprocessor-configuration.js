...
function isFilterSpecsMixedMode(value) {
...
function validateUserConfigurationEntry(key, value) {
    switch (key) {
        ...
        case "usage": {
            if (typeof value !== "object" || value == null) {
                throw new Error(`Expected an object (usage), but got ${util_1.default.inspect(value)}`);
            }
            if (!hasOwnProperty(value, "enabled") ||
                typeof value.enabled !== "boolean") {
                throw new Error(`Expected a boolean (usage.enabled), but got ${util_1.default.inspect(value.enabled)}`);
            }
            let output;
            if (hasOwnProperty(value, "output")) {
                if ((0, type_guards_1.isString)(value.output)) {
                    ...
                    throw new Error(`Expected a string (usage.output), but got ${util_1.default.inspect(value.output)}`);
                }
            }
            const messagesConfig = {
                enabled: value.enabled,
        ...
        case "filterSpecsMixedMode": {
            if (!isFilterSpecsMixedMode(value)) {
                throw new Error(`Unrecognize filterSpecsMixedMode: ${util_1.default.inspect(value)} (valid options are "hide", "show" and "empty-set")`);
            }
            return { [key]: value };
        }
        case "filterSpecs": {
        ...
        case "dryRun": {
            if (!(0, type_guards_1.isBoolean)(value)) {
                throw new Error(`Expected a boolean (dryRun), but got ${util_1.default.inspect(value)}`);
            }
            return { [key]: value };
        }
        case "attachments": {
            ...
            if (!hasOwnProperty(value, "addScreenshots") ||
                typeof value.addScreenshots !== "boolean") {
                throw new Error(`Expected a boolean (attachments.addScreenshots), but got ${util_1.default.inspect(value.addScreenshots)}`);
            }
...
function validateEnvironmentOverrides(environment) {
    ...
    if (hasOwnProperty(environment, "filterSpecsMixedMode")) {
        ...
        if (isFilterSpecsMixedMode(filterSpecsMixedMode)) {
            ...
            throw new Error(`Unrecognize filterSpecsMixedMode: ${util_1.default.inspect(filterSpecsMixedMode)} (valid options are "hide", "show" and "empty-set")`);
        }
    }
    ...
    if (hasOwnProperty(environment, "dryRun")) {
        ...
        if ((0, type_guards_1.isBoolean)(dryRun)) {
            overrides.dryRun = dryRun;
        }
        else if ((0, type_guards_1.isString)(dryRun)) {
            overrides.dryRun = stringToMaybeBoolean(dryRun);
        }
        else {
            throw new Error(`Expected a boolean (dryRun), but got ${util_1.default.inspect(dryRun)}`);
        }
    }
    if (hasOwnProperty(environment, "attachmentsAddScreenshots")) {
        const { attachmentsAddScreenshots } = environment;
        if ((0, type_guards_1.isBoolean)(attachmentsAddScreenshots)) {
            overrides.attachmentsAddScreenshots = attachmentsAddScreenshots;
        }
        else if ((0, type_guards_1.isString)(attachmentsAddScreenshots)) {
            overrides.attachmentsAddScreenshots = stringToMaybeBoolean(attachmentsAddScreenshots);
        }
        else {
            throw new Error(`Expected a boolean (attachmentsAddScreenshots), but got ${util_1.default.inspect(attachmentsAddScreenshots)}`);
        }
    }
    return overrides;
}
...
function combineIntoConfiguration(configuration, overrides, cypress, implicitIntegrationFolder) {
    ...
    const usage = {
        enabled: (_13 = (_11 = (_9 = overrides.usageEnabled) !== null && _9 !== void 0 ? _9 : (_10 = specific === null || specific === void 0 ? void 0 : specific.usage) === null || _10 === void 0 ? void 0 : _10.enabled) !== null && _11 !== void 0 ? _11 : (_12 = unspecific.usage) === null || _12 === void 0 ? void 0 : _12.enabled) !== null && _13 !== void 0 ? _13 : false,
        output: (_18 = (_16 = (_14 = overrides.usageOutput) !== null && _14 !== void 0 ? _14 : (_15 = specific === null || specific === void 0 ? void 0 : specific.usage) === null || _15 === void 0 ? void 0 : _15.output) !== null && _16 !== void 0 ? _16 : (_17 = unspecific.usage) === null || _17 === void 0 ? void 0 : _17.output) !== null && _18 !== void 0 ? _18 : "stdout",
    };
    ...
    const pretty = {
        enabled: (_23 = (_21 = (_19 = overrides.prettyEnabled) !== null && _19 !== void 0 ? _19 : (_20 = specific === null || specific === void 0 ? void 0 : specific.pretty) === null || _20 === void 0 ? void 0 : _20.enabled) !== null && _21 !== void 0 ? _21 : (_22 = unspecific.pretty) === null || _22 === void 0 ? void 0 : _22.enabled) !== null && _23 !== void 0 ? _23 : usingPrettyReporter,
    };
    const filterSpecsMixedMode = (_26 = (_25 = (_24 = overrides.filterSpecsMixedMode) !== null && _24 !== void 0 ? _24 : specific === null || specific === void 0 ? void 0 : specific.filterSpecsMixedMode) !== null && _25 !== void 0 ? _25 : unspecific.filterSpecsMixedMode) !== null && _26 !== void 0 ? _26 : "hide";
    const filterSpecs = (_29 = (_28 = (_27 = overrides.filterSpecs) !== null && _27 !== void 0 ? _27 : specific === null || specific === void 0 ? void 0 : specific.filterSpecs) !== null && _28 !== void 0 ? _28 : unspecific.filterSpecs) !== null && _29 !== void 0 ? _29 : false;
    const omitFiltered = (_32 = (_31 = (_30 = overrides.omitFiltered) !== null && _30 !== void 0 ? _30 : specific === null || specific === void 0 ? void 0 : specific.omitFiltered) !== null && _31 !== void 0 ? _31 : unspecific.omitFiltered) !== null && _32 !== void 0 ? _32 : false;
    const dryRun = (_35 = (_34 = (_33 = overrides.dryRun) !== null && _33 !== void 0 ? _33 : specific === null || specific === void 0 ? void 0 : specific.dryRun) !== null && _34 !== void 0 ? _34 : unspecific.dryRun) !== null && _35 !== void 0 ? _35 : false;
    const isTrackingState = ((_36 = cypress.isTextTerminal) !== null && _36 !== void 0 ? _36 : false) &&
        (messages.enabled ||
            json.enabled ||
            html.enabled ||
            pretty.enabled ||
            ...
            usingPrettyReporter);
    const attachments = {
        addScreenshots: (_41 = (_39 = (_37 = overrides.attachmentsAddScreenshots) !== null && _37 !== void 0 ? _37 : (_38 = specific === null || specific === void 0 ? void 0 : specific.attachments) === null || _38 === void 0 ? void 0 : _38.addScreenshots) !== null && _39 !== void 0 ? _39 : (_40 = unspecific.attachments) === null || _40 === void 0 ? void 0 : _40.addScreenshots) !== null && _41 !== void 0 ? _41 : true,
    };
    return {
        stepDefinitions,
        messages,
